...
class _BrowseScreenState extends State<BrowseScreen> {
  ...
  List<ProjectItem> get filteredProjects {
    var projects = MockData.sampleProjects;
  ...
  Widget build(BuildContext context) {
    ...
    final starredProjects = MockData.sampleProjects.where((p) => p.isFavorite).toList();
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Explore workspace projects, categories, and templates',
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Search projects by name or tag...',
